...
obs_rpath="../../other_observations/radiation/stations/" # Data must be downloaded from https://pangaea.de
wpath="../figures/"
...
fig.savefig(wpath+'pdf/Fig13.pdf', bbox_inches="tight")
fig.savefig(wpath+'png/Fig13.png', bbox_inches="tight")
