...
# Paths to data
# Data must be downloaded from https://search.earthdata.nasa.gov/ or can be provided upon request
ceres_path = "../../other_observations/radiation/CERES_EBAF_Ed4.2_Subset_200704-201003.nc"
...
fig.savefig(fig_path+'pdf/Fig12.pdf', bbox_inches="tight")
fig.savefig(fig_path+'png/Fig12.png', bbox_inches="tight")
plt.clf()