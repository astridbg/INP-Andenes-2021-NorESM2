...
variables = ["SWCFS","LWCFS","TGCLDIWP","TGCLDLWP","CLDLWEMS", "TGCLDTWP", "PREC"]
colorbar_extents = [5, 15, 5, 30, 0.5, 25, 15]
fignames = ["Fig04", "Fig05", "Fig09", "Fig10", "FigB2", "FigB3", "FigB4"]

#------------------------------
# Shaping and plotting fields
#------------------------------
for var, extent, fig_name in zip(variables, colorbar_extents, fignames):
    print(var)
    ...
    plt.savefig(wpath+"pdf/"+fig_name+".pdf", bbox_inches='tight')
    plt.savefig(wpath+"png/"+fig_name+".png", bbox_inches='tight')
